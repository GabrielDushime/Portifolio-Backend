...
export class CertificateService {
  ...
  async create(
    ...
    if (file) {
      ...
      try {
        ...
        const frontendDir = path.join(process.cwd(), '..', 'portfolio-gabriel-frontend', 'public', 'images', 'certificates');
  ...
  private async deleteImageFile(filename: string): Promise<void> {
    try {
      ...
      const frontendPath = path.join(process.cwd(), '..', 'portfolio-gabriel-frontend', 'public', 'images', 'certificates', filename);
